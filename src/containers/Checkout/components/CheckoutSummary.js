...
const CheckoutSummary = () => {
  ...
  return (
    <Box sx={{display:'flex',flexDirection:'column',background:'#f2f2f2',height:'100%',padding:'1rem'}}>
        <Typography variant="h6" color="initial">Resumen de pedido</Typography>
        <Box sx={{display:'flex',flexDirection:'column',gap:1, marginTop:'1rem',flexGrow:1, overflow:'auto'}}>
        {items.map( item =>
